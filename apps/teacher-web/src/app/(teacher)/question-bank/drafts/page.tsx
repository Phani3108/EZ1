/**
 * Phase 16f — HoD draft review queue.
 *
 * Lists pending QuestionDrafts; HoD/SchoolAdmin approves or rejects.
 * The backend gates by school:manage; non-HoD teachers see a 403.
 */
"use client";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Teacher-submitted questions awaiting your review.
        </p>
      </div>
                ...
                <CardContent className="pt-4 space-y-3">
                  ...
                  {d.correct_answer_text && d.question_type !== "MCQ" && (
                    <div className="text-xs text-green-700">
                      Expected answer: {d.correct_answer_text}
                    </div>
                  )}
                  {rejecting === d.id ? (
                    <div className="flex items-center gap-2">
