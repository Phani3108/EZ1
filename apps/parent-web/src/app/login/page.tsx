/**
 * Parent Login Page
 * Credentials: parent@eduzim.com / 123456
 */
...
export default function LoginPage() {
  ...
  const {
    ...
    defaultValues: { email: "parent@eduzim.com", password: "123456" },
  });
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">EduZim Parent Portal</h1>
          ...
          <div className="rounded-2xl bg-white px-8 py-8 shadow-lg ring-1 ring-gray-200">
            ...
            <div className="mt-6 rounded-lg bg-blue-50 px-4 py-3 text-xs text-blue-700">
              ...
              <p>Email: <span className="font-mono">parent@eduzim.com</span></p>
