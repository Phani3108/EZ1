...
# PH3 / BUG-007: communications no longer decodes JWTs. Tests inject the
# gateway-provided headers directly (X-Gateway-Token + identity headers).
...
# Back-compat alias — keeps existing call sites readable.
_teacher_headers = _gateway_headers
