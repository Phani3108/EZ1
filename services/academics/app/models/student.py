...
class Student(Base):
    ...
    # Phase 12a / PH12-1. Link to Identity User when the school has
    # activated a digital account for this student. Null = student
    # hasn't been provisioned a login yet (the parent-mediated path).
    # Set by /parents/me/children/{id}/activate-student or the admin
    # bulk-activate equivalent on admin-web.
