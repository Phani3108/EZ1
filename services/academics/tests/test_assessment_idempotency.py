...
os.environ["DATABASE_URL"] = "sqlite:///./test_academics_assessment_idempotency.db"
...
engine = create_engine(
    "sqlite:///./test_academics_assessment_idempotency.db",
...
def setup_db():
    ...
    if os.path.exists("./test_academics_assessment_idempotency.db"):
        try:
            os.remove("./test_academics_assessment_idempotency.db")
        except OSError:
            pass
...
def _gateway_headers(user_id=None, school_id=None, roles=None, request_id=None):
    h = {
...
def _teacher_headers(user_id=None, school_id=None, request_id=None):
    return _gateway_headers(user_id, school_id, ["Teacher"], request_id)


def _admin_headers(user_id=None, school_id=None, request_id=None):
    return _gateway_headers(user_id, school_id, ["Admin"], request_id)
