...
os.environ["DATABASE_URL"] = "sqlite:///./test_academics_school.db"
...
engine = create_engine("sqlite:///./test_academics_school.db", connect_args={"check_same_thread": False})
...
def setup_db():
    ...
    if os.path.exists("./test_academics_school.db"):
        try:
            os.remove("./test_academics_school.db")
        except OSError:
            pass
