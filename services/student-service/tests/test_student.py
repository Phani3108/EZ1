...
os.environ["DATABASE_URL"] = "sqlite:///./test_student.db"
...
engine = create_engine("sqlite:///./test_student.db", connect_args={"check_same_thread": False})
...
def setup_db():
    ...
    if os.path.exists("./test_student.db"):
        try:
            os.remove("./test_student.db")
        except OSError:
            pass
