"""JWT dependencies + teacher / parent authorization for assessment-service."""
import uuid
import httpx
...
def is_parent_role(current_user: dict) -> bool:
...
async def verify_parent_student_authorization(
    ...
    """Call student-service internal endpoint to verify parent-child link."""
    url = f"{settings.STUDENT_SERVICE_URL}/internal/parents/authorize"
    params = {
